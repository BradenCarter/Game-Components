...
public class SafeArea : MonoBehaviour
{
    ...
    private Rect[] NSA_iPhoneX = new Rect[]
    {
            ...
            new Rect (100f / 2436f, 63f / 1125f, 2300f / 2436f, 1062f / 1125f)  // Landscape
    };
    ...
    private Rect[] NSA_iPhoneXsMax = new Rect[]
    {
            ...
            new Rect (110f / 2688f, 63f / 1242f, 2537f / 2688f, 1179f / 1242f)  // Landscape
    };
    ...
    [SerializeField]
    private bool useSimValues = true;
    ...
    private void Awake()
    {
        ...
        if (useSimValues)
        {
            ...
            if (deviceID == "iPhone10,3 " || deviceID == "iPhone10,6" || deviceID == "iPhone11,2")
            {
                Sim = SimDevice.iPhoneX;
            }
            else if (deviceID == "iPhone11,4 " || deviceID == "iPhone11,6")
            {
